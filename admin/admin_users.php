...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_admin.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> ajouter nouveau</a>
            </div>
        </div>
    </div>
    ...
    <div class="well text-center filter-form">
        <form class="form form-inline" action="">
            <label for="input_search">chercher</label>
            <input type="text" class="form-control" id="input_search" name="search_string" >
            <label for="input_order">classer par</label>
            ...
            <input type="submit" value="demarrer" class="btn btn-primary">
        </form>
    </div>
    <hr>
    <!-- //Filters -->
